...
// 1. Query Analysis
{
  "type": "query_analysis",
  "content": {
    "query": "Wo war ich gestern mit Nora?",
    "persons": ["Nora"],
...
// 3. Retrieval Progress
{
  ...
  "content": {
    "collection": "photos",
    "query_variant": "Ort mit Nora gestern",
    "results_count": 3,
...
├────────────────────────────────────────────────────────────┤
│                                                             │
│  Du: Wo war ich gestern mit Nora?                         │
│                                                             │
│  🦕 Memosaur:                                              │
│  ┌─────────────────────────────────────────────────────┐  │
...
│  │    • Query: "Ort mit Nora gestern"                   │  │
│  │    • Gefunden: 3 Ergebnisse                         │  │
│  ├─────────────────────────────────────────────────────┤  │
│  │ 🔍 Suche in Nachrichten (2/2)...        ⏳ läuft   │  │
│  └─────────────────────────────────────────────────────┘  │
│                                                             │
│  Gestern warst du mit Nora im Restaurant Poseidon...      │
...
Du bist Memosaur, ein analytischer RAG-Agent.
...
1. **Vor jedem Tool-Call**: Erkläre KURZ (1 Satz) was du tust
   Beispiel: "Ich suche jetzt in Fotos nach Nora vom 09.03.2026."
...
2. **Complex Query** (mit Chain-of-Thought)
   - "Wo war ich letztes Jahr im August mit Nora?"
