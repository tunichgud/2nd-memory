...
Alle drei Modelle erreichen denselben Score — das FAIL-Ergebnis (Marius-Treffpunkt) ist strukturell: Die relevante Nachricht war schlicht nicht in den Top-Retrieval-Ergebnissen enthalten.
...
|----|-------|-----|---------|
| `q_20260311_150705_0170df` | Wo treffe ich mich heute mit Marius? | Zeitlich + Person | ❌ FAIL |
| `q_20260311_151849_8bf1fb` | Wo war ich mit Nora im letzten August? | Temporal + Person + Foto | ✅ PASS |
| `q_20260311_151907_f749db` | Wo war ich mit Nora im letzten Sommer? | Temporal fuzzy + Person + Foto | ✅ PASS |
...
- **Personen auf Fotos:** Nora (241), Sarah (86), Josh/Joshua (42+56), Monika (16), Frieda (5), Marius (1), ...

---

## Bekannte Schwäche (strukturell)

Der Marius-Treffpunkt-Test schlägt fehl, weil:
