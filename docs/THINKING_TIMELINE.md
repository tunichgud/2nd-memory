...
```json
{
  ...
  "content": {
    ...
    "sub_queries": [
      ...
      "Schritt 2: Suche Marie-Nachrichten in diesem Zeitraum"
    ],
...
```markdown
User: "Was habe ich mit Anna in München gemacht?"
...
💭 Jetzt filtere ich nach Anna...

📷 Tool: search_photos                 ⚙️
   personen=["Anna"], orte=["München"]
   → 8 neue Quellen                    ✓
...
[Antwort-Bubble]
Du warst im August 2024 mit Anna in **München-Schwabing** [[1]].
