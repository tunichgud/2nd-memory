...
Unser WhatsApp-Integration hatte eine kritische Limitierung: Die Historie-Funktion konnte nicht alle Nachrichten aus einem Chat laden. Für den Chat mit "Theodore Tetzlaff" wurden nur 1 Nachricht angezeigt, obwohl hunderte Nachrichten existieren sollten.
...
| **Sarah Chat** | 1 Message sichtbar | 0 Messages geladen |
...
```bash
# Sarah Ohnesorge: 3020 chunks aus WhatsApp TXT-Export
