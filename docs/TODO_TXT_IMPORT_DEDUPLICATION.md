...
```
[09.03.26, 23:15:42] Sarah: Hallo Josh!
[09.03.26, 23:16:10] Ich: Hey Sarah!
```
...
def parse_whatsapp_txt_line(line: str, chat_id: str):
    ...
    Input:  "[09.03.26, 23:15:42] Sarah: Hallo Josh!"
    Output: {
        'id': 'wa_491786838260@c.us_1741562142_sarah',
...
def migrate_sarah_txt_imports():
    """
    Migriert die 3025 Sarah TXT-Import Messages zu korrekten IDs.
    """
    col = get_collection("messages")

    # Hole alle TXT-Import Messages
    old_msgs = col.get(
        where={"chat_name": "Sarah Ohnesorge", "source": "whatsapp"},
...
1. Test re-import von Sarah TXT
2. Test Live-Import von Sarah Messages
3. Query RAG: "Was weißt du über Sarah?"
...
✅ 3025 Sarah Messages migriert zu neuen IDs
...
- 11:00-11:30: Testing
- 11:30-12:00: Migration Sarah Data
