"""
main.py – FastAPI Hauptanwendung für 2nd Memory.
...
# ENV: CORS_ORIGINS=http://localhost:3000,https://2nd-memory.example.com
...
async def startup_event():
    ...
    await init_db()
    logger.info("2nd-memory v2 gestartet.")
...
async def health() -> dict:
    return {"status": "ok", "app": "2nd-memory", "version": "2.0.0"}
