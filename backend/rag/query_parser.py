"""
query_parser.py – LLM-basierter Query-Parser für 2nd Memory.
...
- Beispiel: Vorherige Frage: "Wo war ich im August?"
           Aktuelle Frage: "Wie fühlte sich Marie dabei?"
...
{{
  ...
  "schluesselwoerter": []  // Exakte Begriffe die im Text vorkommen MÜSSEN (Keyword-Suche).
                           ...
                           // Beispiel: "Was schrieb Marie über Willi?" → schluesselwoerter=["Willi"]
}}
...
def _extract_rules(pq: ParsedQuery) -> None:
    ...
    person_keywords = ["mit ", "wer ", "anna", "marie", "alex", "personen"]
...
def _person_field(name: str) -> str:
    ...
    Beispiel: "Alex Mueller" → "has_alex", "Anna" → "has_anna"
    """
