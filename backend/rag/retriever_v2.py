"""
retriever_v2.py – Token-aware RAG-Retrieval für 2nd Memory v2.
...
Du bist ein analytischer Agent (2nd Memory) für ein persönliches Gedächtnis-System.
...
BEISPIEL:
User: "Wo war ich im August 2022 mit Anna?"
→ Thought: Ich suche nach Fotos mit Anna im August 2022, um den Ort zu finden.
→ Tool: search_photos(personen=["Anna"], von_datum="2022-08-01", bis_datum="2022-08-31")
→ Observation: [Foto vom 15.08.2022, cluster="München-Schwabing", GPS: 48.16°N 11.58°E]
→ Antwort: "Du warst im August 2022 mit Anna in **München (Schwabing)** [[1]]. Auf dem Foto vom 15. August sieht man euch am Englischen Garten [[1]]."
...
- Plane in Schritten! Wenn der Nutzer eine komplexe Frage stellt, überlege erst:
  ...
  * Beispiel: "Wie ging es Marie, als ich mit Anna in München war?"
    -> Schritt 1: Finde das Datum des München-Aufenthalts mit Anna via search_photos(personen=["Anna"], orte=["München"]).
    -> Schritt 2: Suche gezielt nach Nachrichten von Marie in diesem Zeitraum.
