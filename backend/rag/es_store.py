"""
es_store.py – Elasticsearch Interface für 2nd Memory.
...
def _print_es_error(hosts: list):
    ...
    print("="*80)
    print(f"\n 2nd-memory benötigt Elasticsearch zur Suche, aber unter {hosts}")
...
def get_index_name(collection_name: str) -> str:
    cfg = _get_config()
    prefix = cfg.get("elasticsearch", {}).get("index_prefix", "2nd_memory_")
