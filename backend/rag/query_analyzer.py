...
Beispiel:
  "Was kann ich Sarah zum Geburtstag schenken?"
  → AnalyzedQuery(
...
3. **multi_entity_reasoning**: Mehrere Entitäten verknüpft
   - Beispiel: "Was habe ich mit Sarah in München gemacht?"
   - Strategie: Schritt 1: Finde Datum (München-Aufenthalt) → Schritt 2: Suche Sarah-Messages/Fotos in diesem Zeitraum

4. **recommendation**: Empfehlungen ableiten
   - Beispiel: "Was kann ich Sarah zum Geburtstag schenken?"
   - Strategie: Schritt 1: Sammle Infos über Sarah → Schritt 2: Extrahiere Interessen → Schritt 3: Generiere Ideen
...
User: "Was habe ich mit Sarah in München gemacht?"
{{
  "query_type": "multi_entity_reasoning",
  "complexity": "medium",
  "sub_queries": [
    "Finde Zeitraum des München-Aufenthalts via Fotos",
    "Suche Nachrichten mit Sarah in diesem Zeitraum",
    "Suche Fotos mit Sarah in München"
  ],
  "temporal_fuzzy": false,
...
User: "Was kann ich Sarah zum Geburtstag schenken?"
{{
  "query_type": "recommendation",
  "complexity": "complex",
  "sub_queries": [
    "Finde alle Nachrichten mit Sarah",
    "Finde alle Fotos mit Sarah",
    "Extrahiere Sarahs Interessen und Hobbies aus Nachrichten und Foto-Beschreibungen",
