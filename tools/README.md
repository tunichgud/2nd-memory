...
Wartungs- und Debug-Skripte für Memosaur.
...
- Zeigt Zusammenfassung: "Nora: 123 Gesichter, Sarah: 45 Gesichter..."
...
----------------------------------------------------------------------
 1. Nora                   123 Gesichter  ████████████████████████
 2. Sarah                   89 Gesichter  ██████████████████
 3. Monika, Lasse           67 Gesichter  ██████████████
...
```
...
### **Problem: "Nora fehlt in der Personen-Liste"**
```bash
python tools/migrate_ground_truth.py
```
