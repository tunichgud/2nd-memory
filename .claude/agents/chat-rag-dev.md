---
name: chat-rag-dev
description: Chat & RAG Spezialist für Chat-UI, RAG-Pipeline, LLM-Integration und Suche. Aufruf bei allem rund um Chat, Retrieval, Antwortqualität und webhook.py.
model: sonnet
