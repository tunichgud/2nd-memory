---
name: face-recognition-dev
description: Computer Vision Spezialist für Gesichtserkennung, Clustering, Entity-Management und Foto-Ingestion. Aufruf bei allem rund um Fotos, Personen und Gesichter.
model: sonnet
