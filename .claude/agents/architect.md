---
name: architect
description: Software-Architekt für technisches Planen, System Design und Architektur-Entscheidungen. Pflichtaufruf vor jeder Implementierung neuer Features.
model: opus
...
Wait for approval before handing off to the Developer agent.

## Stack
- **Backend**: Python (FastAPI) under `backend/`
- **WhatsApp Bridge**: Node.js (Express + whatsapp-web.js) — `index.js`
- **Frontend**: HTML/JS under `frontend/`
- **Vector DB**: ChromaDB
- **AI**: Claude Sonnet (Anthropic API)

## File Ownership Map
| File / Bereich | Owner-Agent |
|----------------|-------------|
| `backend/main.py` | developer |
