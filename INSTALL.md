# Installationsanleitung – 2nd Memory v2
...
> **Browser-Anforderung:** 2nd-memory v2 verwendet moderne Web-Technologien wie IndexedDB
...
> **Ollama auf einem anderen Rechner** (z.B. Windows-Host, 2nd-memory in WSL2):
...
# 2nd-memory liest beide Formate automatisch
...
```
Initialisiere SQLite-Datenbank: data/2nd-memory.db
Default-User 'ManfredMustermann' angelegt (ID: 00000000-...)
2nd-memory v2 gestartet.
...
2nd Memory kann live auf WhatsApp-Nachrichten reagieren:
...
6. 2nd Memory antwortet nun live auf eingehende Nachrichten!
